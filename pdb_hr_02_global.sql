...
where dbid in (db_id('TalentGate'),db_id('EngineeringDB'),db_id('MarketingDB'),db_id('SupportDB'),db_id('TalentGlobalDB')) and cmd = 'AWAITING COMMAND' and spid <> @@spid;
exec(@sql);
end;
go
...
insert into PdbPositions (DepartmentId,Name) values (4,'Financial Collector');
insert into PdbPositions (DepartmentId,Name) values (5,'Product Manager');
insert into PdbPositions (DepartmentId,Name) values (6,'Solution Architect');
